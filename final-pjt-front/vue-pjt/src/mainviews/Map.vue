...
<<<<<<< HEAD
  ...
  export default {
    data() {
      return {
        map: null, // Add map as a data property
      };
    },
    mounted() {
...
onMounted(async () => {
    if (window.kakao && window.kakao.maps) {
        ...
        /* global kakao */
        //autoload 스크립트의 로딩이 끝나기전에 v3객체에 접근하면 에러 발생
        //로딩이 끝나는 시점에 콜백을 통해 객체에 접근.
        //비동기 통신으로 페이지 v3를 동적으로 삽입할 경우 주로 사용됨, autoload=false
...
const initMap = function () {
    ...
    const mapOption = {
        //지도 중심 축
        center: new kakao.maps.LatLng(35.20100, 126.810864),
        //지도 확대  레벨 
        level: 5,
    };
