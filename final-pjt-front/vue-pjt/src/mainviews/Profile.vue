        ...
        <div class="d-flex">
            ...
            <div>
                ...
                <div v-for="(product, index) in recomment_conf" :key="index">
                    ...
                    <div v-if="recomment_day==6 && product.type=='단리'">6개월 예상 수익 : {{ (store.UserDetail.salary-store.UserDetail.consumption)/12*6*(1+product.month6/100)*0.5 }}</div>
                    <div>
                        <div v-if="recomment_day==6 && product.type=='단리' && store.UserDetail.goal_money+store.UserDetail.loan_money-(store.UserDetail.salary-store.UserDetail.consumption)/12*6*(1+product.month6/100)*0.5 > 0">6개월 후 남은 목표금액(대출금 포함) : {{ store.UserDetail.goal_money+store.UserDetail.loan_money-(store.UserDetail.salary-store.UserDetail.consumption)/12*6*(1+product.month6/100)*0.5 }}</div>
                    ...
                    <div v-if="recomment_day==6 && product.type=='복리'">6개월 예상 수익 : {{ (store.UserDetail.salary-store.UserDetail.consumption)/12*6*(((1+product.month6/100/12)^6-1)^6+1) }}</div>
                    <div>
                        <div v-if="recomment_day==6 && product.type=='복리' && store.UserDetail.goal_money+store.UserDetail.loan_money-(store.UserDetail.salary-store.UserDetail.consumption)/12*6*(((1+product.month6/100/12)^6-1)^6+1) > 0">6개월 후 남은 목표금액(대출금 포함) : {{ store.UserDetail.goal_money+store.UserDetail.loan_money-(store.UserDetail.salary-store.UserDetail.consumption)/12*6*(((1+product.month6/100/12)^6-1)^6+1) }}</div>
                    ...
                    <div v-if="recomment_day==12 && product.type=='단리'">12개월 예상 수익 : {{ (store.UserDetail.salary-store.UserDetail.consumption)/12*12*(1+product.month12/100) }}</div>
                    <div>

                        <div v-if="recomment_day==12 && product.type=='단리' && store.UserDetail.goal_money+store.UserDetail.loan_money-(store.UserDetail.salary-store.UserDetail.consumption)/12*12*(1+product.month12/100) > 0">12개월 후 남은 목표금액(대출금 포함) : {{ store.UserDetail.goal_money+store.UserDetail.loan_money-(store.UserDetail.salary-store.UserDetail.consumption)/12*12*(1+product.month12/100) }}</div>
                    ...
                    <div v-if="recomment_day==12 && product.type=='복리'">12개월 예상 수익 : {{ (store.UserDetail.salary-store.UserDetail.consumption)/12*12*(((1+product.month12/100/12)^12-1)^12+1) }}</div>
                    <div v-if="recomment_day==12 && product.type=='복리'">12개월 후 남은 목표금액(대출금 포함) : {{ store.UserDetail.goal_money+store.UserDetail.loan_money-(store.UserDetail.salary-store.UserDetail.consumption)/12*12*(((1+product.month12/100/12)^12-1)^12+1) }}</div>
                    <div v-if="recomment_day==24 && product.type=='단리'">24개월 예상 수익 : {{ (store.UserDetail.salary-store.UserDetail.consumption)/12*24*(1+product.month24/100)*2 }}</div>
                    <div v-if="recomment_day==24 && product.type=='단리'">12개월 후 남은 목표금액(대출금 포함) :  {{ store.UserDetail.goal_money+store.UserDetail.loan_money-(store.UserDetail.salary-store.UserDetail.consumption)/12*24*(1+product.month24/100)*2 }}</div>
                    <div v-if="recomment_day==24 && product.type=='복리'">24개월 예상 수익 :  {{ (store.UserDetail.salary-store.UserDetail.consumption)/12*24*(((1+product.month24/100/12)^24-1)^24+1) }}</div>
                    <div v-if="recomment_day==24 && product.type=='복리'">12개월 후 남은 목표금액(대출금 포함) :  {{ store.UserDetail.goal_money+store.UserDetail.loan_money-(store.UserDetail.salary-store.UserDetail.consumption)/12*24*(((1+product.month24/100/12)^24-1)^24+1) }}</div>
                </div>
            </div>
        </div>
</template>
